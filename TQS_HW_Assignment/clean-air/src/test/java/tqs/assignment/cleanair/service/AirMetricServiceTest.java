...
public class AirMetricServiceTest {
    ...
    @Test
    public void whenGetCurrentByLocationAirMetricsInCache_thenCacheShoulBeConsulted(){
        ...
        assertEquals(airMetricService.getCurrentAirMetricByLocation("Porto"),airMetric_single, "AirMetric Service getting wrong cache Metric");
    ...
    public void whenGetCurrentByLocationAirMetricsNotInCache_thenAPIShoulBeConsulted() throws IOException, MalformedURLException{
        ...
        when(airMetricCache.containsMetrics("NOW_Porto")).thenReturn(false);
    ...
    @Test 
    public void whenGetCurrentByLocationInvalid_thenShouldReturnEmptyOptional(){
        assertTrue(!airMetricService.getCurrentAirMetricByLocation("CIDADE").isPresent(),"AirMetric Service accepting wrong city values" );
    }

    @Test
    public void whenGetAirMetricsByLocationAndTimeInCache_thenCacheShoulBeConsulted(){
        ...
        assertEquals(airMetricService.getAirMetricsByLocationAndTime("Porto",2,4),airMetrics, "AirMetric Service getting wrong cache Metric");
    ...
    public void whenGetAirMetricsByLocationAndTimeNotInCache_thenAPIShoulBeConsulted() throws IOException, MalformedURLException{
        ...
        when(extApi.getMetricsFromAPI(API_URL)).thenReturn(airMetrics);
    ...
    @Test
    public void whenGetAirMetricsByLocationAndTimeInvalidTime_thenShouldReturnEmptyOptional(){
    ...
    @Test
    public void whenGetAirMetricsByLocationAndTimeInvalidLocation_thenShouldReturnEmptyOptional(){
